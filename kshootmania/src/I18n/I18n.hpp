...
namespace I18n
{
	...
	enum class Option
	{
		...
		TimingAdjustMs,
		LaserTimingAdjustLater,
		LaserTimingAdjustEarlier,
		...
		ItemFXObject,
		ItemLaserObject,
		ItemLaserObjectInputType,
		ItemAssistTick,
		ItemDisableIME,
		ItemTimingAdjustment,
		ItemLaserObjectTimingAdjustment,
		ItemMouseXSignalDirection,
		ItemMouseYSignalDirection,
		ItemSliderMouseSignalSensitivity,
		ItemSwapLRLaser,
