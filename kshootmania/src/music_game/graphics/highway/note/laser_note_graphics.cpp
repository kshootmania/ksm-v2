...
namespace MusicGame::Graphics
{
	...
	void LaserNoteGraphics::draw(const kson::ChartData& chartData, const GameStatus& gameStatus, const HighwayScroll& highwayScroll, const HighwayRenderTexture& target) const
	{
