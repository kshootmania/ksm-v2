...
namespace MusicGame::Judgment
{
	...
	private:
		...
		void processKeyDown(const kson::ByPulse<kson::Interval>& lane, kson::Pulse currentPulse, double currentTimeSec, double smoothDeltaTimeSec, ButtonLaneStatus& laneStatusRef);
	...
	public:
		...
		void update(const kson::ByPulse<kson::Interval>& lane, kson::Pulse currentPulse, double currentTimeSec, double smoothDeltaTimeSec, ButtonLaneStatus& laneStatusRef);
